...
3. Once the container image has built, launch a container using:
...
6. Next, create a new repository in your personal GitHub profile. Name your repository `assignment-9-code-scanning` (or something similar). Then set your local project’s upstream to that repository and push your code: 
...
Like we did in Assignment 8, we’ll add a GitHub Actions workflow to scan our code for vulnerabilities. 
